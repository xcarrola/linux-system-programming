...
main(int argc, char *argv[])
{
    ...
    /* FIXME: Add the file descriptors for the socket and standard input
       to the interest list of the epoll instance, monitoring each
    ...
    /* FIXME: NOTE!! It will simplify the code logic if you use epoll_wait() to
       fetch just *one* file descriptor at a time. If both file descriptors
       happen to be ready at the same time, then the *next* call to
       epoll_wait() will return information about the other descriptor. */
